sap.ui.define([
    ...
    var ComponentBrowseType = BrowseBase.extend("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.ComponentBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new ComponentBrowseType("componentBrowse", {
                sFragmentName: "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.ComponentBrowse",
