sap.ui.define([
    ...
    var CalculatedInfoPopoverType = BaseObject.extend("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.CalculatedInfoPopover", {
        ...
        constructor: function (sId, mSettings) {
            ...
            if (!this._oCalculatedInfoPopoverView) {
                this._oCalculatedInfoPopoverView = sap.ui.xmlfragment(this._sBaseId, "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.fragments.CalculatedInfo", this);
