sap.ui.define([
    ...
    "stellium/ext/podplugins/supervisorMaterialConsumptionPlugin/controller/BomBrowse",
    "stellium/ext/podplugins/supervisorMaterialConsumptionPlugin/controller/RoutingBrowse"
], function (BrowseBase, JSONModel, StatusFormatter, ObjectTypeFormatter, BomBrowse, RoutingBrowse) {
    "use strict";

    var MaterialBrowseType = BrowseBase.extend("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.MaterialBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new MaterialBrowseType("materialBrowse", {
                ...
                sFragmentName: "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.browse.materialBrowse",
