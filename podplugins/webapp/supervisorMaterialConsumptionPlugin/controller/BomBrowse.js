sap.ui.define([
  ...
  "stellium/ext/podplugins/supervisorMaterialConsumptionPlugin/controller/ComponentBrowse",
  ...
  var BomBrowseType = BrowseBase.extend("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.BomBrowse", {
  ...
  return {
      ...
      open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
          return new BomBrowseType("bomBrowse", {
              ...
              oModel: oModel,
              sFragmentName: "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.browse.BomBrowse",
