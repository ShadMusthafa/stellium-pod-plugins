sap.ui.define([
    "stellium/ext/podplugins/supervisorMaterialConsumptionPlugin/controller/CommonConsumeHandler",
    "./../utils/formatter",
    ...
    "use strict";
    const oLogger = Logging.getLogger("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.WeighDispenseHandler");
    var WeighDispenseHandler = CommonConsumeHandler.extend("stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.controller.WeighDispenseHandler", {
        ...
        openWeighingDialog: function () {
            ...
            if (!oWeighingDialog) {
                let sPopupPath = "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.fragments.WeighPopup";
                Fragment.load({
                    id: oView.getId(),
                    name: sPopupPath,
        ...
        openWeighingScanDialog: function () {
            ...
            if (!oScanWeighingDialog) {
                Fragment.load({
                    id: oView.getId(),
                    name: "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.fragments.ScannerWeighDialog",
                    controller: this.oMaterialConsumptionController
                }).then(function (oDialog) {
        ...
        openWeighingAddDialog: function () {
            ...
            if (!oAddWeighingDialog) {
                Fragment.load({
                    id: oView.getId(),
                    name: "stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.view.fragments.AddWeighMaterial",
                    controller: this.oMaterialConsumptionController
                }).then(function (oDialog) {
