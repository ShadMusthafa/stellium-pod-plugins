sap.ui.define(['sap/ui/model/resource/ResourceModel', 'sap/dm/dme/podfoundation/control/PropertyEditor'], function(
  ResourceModel,
  PropertyEditor
) {
  'use strict';

  return PropertyEditor.extend('stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('materialConsumptionConfig.');
      this.setResourceBundleName('stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.i18n.builder');
      this.setPluginResourceBundleName('stellium.ext.podplugins.supervisorMaterialConsumptionPlugin.i18n.i18n');
    },
    ...
    addPropertyEditorContent: function(oPropertyFormContainer) {
      ...
      this.addSwitch(oPropertyFormContainer, 'allowWeighWithoutTolerance', oData);
