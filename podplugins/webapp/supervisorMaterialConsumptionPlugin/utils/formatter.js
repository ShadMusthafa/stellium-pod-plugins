    ...
    return {
      ...
      getUpperAndLowerThresholdValues: function(
        ...
        var upperValue = 0,
          lowerValue = 0,
          thresholdValues = {};
        var targetValue = this.formatter
          ? this.formatter.getValidQty(totalQtyEntryUom, totalQtyBaseUom, targetQuantity)
          : this.getValidQty(totalQtyEntryUom, totalQtyBaseUom, targetQuantity);
      ...
      formatBatchQuantityAdv: function(qty, uom) {
        ...
        if (uom) return NumInstance.format(qty) + ' ' + uom;
