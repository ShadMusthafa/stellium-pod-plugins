  ...
  function(
    ...
    return ListPluginViewController.extend('stellium.ext.podplugins.packingPluginToshif.controller.PackingUnits', {
      ...
      onCreatePackingUnitPressed: function() {
        window.open("https://djn-s4dev.daajan.com:44300/sap/bc/ui2/flp?sap-system-login-oninputprocessing=onProceed&sap-urlscheme=http&sap-client=110&sap-language=EN#ZHU02-create?sap-ui-tech-hint=GUI?Order=029999321&Operation=operation1&Username=Lohith&SFC=SFC1", "_blank");
        // if (!this.oDialog) {
