    ...
    return PluginControllerExtension.extend('stellium.ext.podplugins.orderPodSelectionExtensionProvider.LifecycleExtension', {
      ...
      onAfterRendering: function (oEvent) {
        ...
        setTimeout(function () {
          ...
          let bShowCustomChargeStatusFitler = that.getController().getConfiguration().showCustomChargeStatus;
          if (bShowCustomChargeStatusFitler) {
          ...
          //Hide the resource filter if the prop is set
          let bShowResourceFilter = that.getController().getConfiguration().showResourceFilter;
          if (!bShowResourceFilter) {
            that.getController().byId('resourceFilter').getParent().setVisibleInFilterBar(false);
          }
