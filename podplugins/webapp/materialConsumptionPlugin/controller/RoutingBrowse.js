sap.ui.define([
    ...
    "stellium/ext/podplugins/materialConsumptionPlugin/controller/ListFilterRoutingBrowse"
], function (JSONModel, BrowseBase, StatusFormatter, ObjectTypeFormatter, ListFilterRoutingBrowse) {
    "use strict";

    var RoutingBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPlugin.controller.RoutingBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new RoutingBrowseType("routingBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPlugin.view.browse.RoutingBrowse",
