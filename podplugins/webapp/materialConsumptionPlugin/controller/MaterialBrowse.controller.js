sap.ui.define([
    ...
    "stellium/ext/podplugins/materialConsumptionPlugin/controller/BomBrowse",
    "stellium/ext/podplugins/materialConsumptionPlugin/controller/RoutingBrowse"
], function (BrowseBase, JSONModel, StatusFormatter, ObjectTypeFormatter, BomBrowse, RoutingBrowse) {
    "use strict";

    var MaterialBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPlugin.controller.MaterialBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new MaterialBrowseType("materialBrowse", {
                ...
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPlugin.view.browse.materialBrowse",
