sap.ui.define([
  ...
  "stellium/ext/podplugins/materialConsumptionPlugin/controller/ComponentBrowse",
  ...
  var BomBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPlugin.controller.BomBrowse", {
  ...
  return {
      ...
      open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
          return new BomBrowseType("bomBrowse", {
              ...
              oModel: oModel,
              sFragmentName: "stellium.ext.podplugins.materialConsumptionPlugin.view.browse.BomBrowse",
