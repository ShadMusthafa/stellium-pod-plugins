sap.ui.define([
    ...
    "stellium/ext/podplugins/materialConsumptionPlugin/utils/formatter"
], function (BrowseBase, Formatter) {
    "use strict";

    var StorageLocationBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPlugin.controller.StorageLocationBrowse", {
        formatter: Formatter,
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPlugin.view.browse.StorageLocationsBrowse",
        ...
        openMulti: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
             return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPlugin.view.browse.StorageLocationsBrowseMulti",
                oParentControl: oParentControl,
                sDefaultSearchValue: sDefaultSearchValue,
                fnSelectionCallback: fnSelectionCallback,
                oFilterSettings: {
