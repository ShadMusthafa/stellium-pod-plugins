sap.ui.define([
    ...
    return ListFilter.extend("stellium.ext.podplugins.postProductionReportingPlugins.controller.ListFilterRoutingBrowse", {
        ...
        filterBySearchValue: function (sSearchValue) {
            var aFilter = this._createBasicSearchFilter(sSearchValue);
