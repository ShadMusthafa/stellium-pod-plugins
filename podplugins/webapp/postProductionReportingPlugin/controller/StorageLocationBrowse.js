sap.ui.define([
    ...
    var StorageLocationBrowseType = BrowseBase.extend("stellium.ext.podplugins.postProductionReportingPlugin.controller.StorageLocationBrowse", {
        formatter: Formatter,
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.postProductionReportingPlugin.view.browse.StorageLocationsBrowse",
        ...
        openMulti: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
             return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.postProductionReportingPlugin.view.browse.StorageLocationsBrowseMulti",
                oParentControl: oParentControl,
                sDefaultSearchValue: sDefaultSearchValue,
                fnSelectionCallback: fnSelectionCallback,
                oFilterSettings: {
