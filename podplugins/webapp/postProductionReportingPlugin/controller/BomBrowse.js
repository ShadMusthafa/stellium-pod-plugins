sap.ui.define([
    ...
    "stellium/ext/podplugins/postProductionReportingPlugin/controller/ComponentBrowse",
    ...
    var BomBrowseType = BrowseBase.extend("stellium.ext.podplugins.postProductionReportingPlugin.controller.BomBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new BomBrowseType("bomBrowse", {
                ...
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.postProductionReportingPlugin.view.browse.BomBrowse",
