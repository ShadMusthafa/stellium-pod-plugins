sap.ui.define([
    ...
    "stellium/ext/podplugins/postProductionReportingPlugin/controller/BomBrowse",
    "stellium/ext/podplugins/postProductionReportingPlugin/controller/RoutingBrowse"
], function (BrowseBase, JSONModel, StatusFormatter, ObjectTypeFormatter, BomBrowse, RoutingBrowse) {
    "use strict";

    var MaterialBrowseType = BrowseBase.extend("stellium.ext.podplugins.postProductionReportingPlugin.controller.MaterialBrowse", {
        ...
        createResultData: function (oBindingContext,oClickedListItem) {
            var oBindingContext = oClickedListItem.getBindingContext("product");
        	return {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback) {
            return new MaterialBrowseType("materialBrowse", {
                ...
                sFragmentName: "stellium.ext.podplugins.postProductionReportingPlugin.view.browse.materialBrowse",
