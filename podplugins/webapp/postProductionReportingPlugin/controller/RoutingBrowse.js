sap.ui.define([
    ...
    "stellium/ext/podplugins/postProductionReportingPlugin/controller/ListFilterRoutingBrowse"
], function (JSONModel, BrowseBase, StatusFormatter, ObjectTypeFormatter, ListFilterRoutingBrowse) {
    "use strict";

    var RoutingBrowseType = BrowseBase.extend("stellium.ext.podplugins.postProductionReportingPlugin.controller.RoutingBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new RoutingBrowseType("routingBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.postProductionReportingPlugin.view.browse.RoutingBrowse",
