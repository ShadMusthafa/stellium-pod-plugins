sap.ui.define([
    ...
    "stellium/ext/podplugins/materialConsumptionPluginV2/utils/formatter"
], function (BrowseBase, Formatter) {
    "use strict";

    var StorageLocationBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPluginV2.controller.StorageLocationBrowse", {
        formatter: Formatter,
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPluginV2.view.browse.StorageLocationsBrowse",
        ...
        openMulti: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
             return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPluginV2.view.browse.StorageLocationsBrowseMulti",
                oParentControl: oParentControl,
                sDefaultSearchValue: sDefaultSearchValue,
                fnSelectionCallback: fnSelectionCallback,
                oFilterSettings: {
