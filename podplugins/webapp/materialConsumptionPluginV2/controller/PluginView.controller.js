sap.ui.define(
  [
    ...
    'sap/m/MessageBox',
    'stellium/ext/podplugins/materialConsumptionPluginV2/controller/MaterialBrowse',
    'stellium/ext/podplugins/materialConsumptionPluginV2/controller/CalculateDialog.controller',
    'sap/dm/dme/controller/FormulaCalculatedInfo.controller',
    'stellium/ext/podplugins/materialConsumptionPluginV2/controller/StorageLocationBrowse',
    ...
    'stellium/ext/podplugins/materialConsumptionPluginV2/controller/WeighDispenseHandler',
  ...
  function(
    ...
    'use strict';
    var oLogger = Logging.getLogger('stellium.ext.podplugins.materialConsumptionPluginV2.controller.PluginView');
    return ListPluginViewController.extend('stellium.ext.podplugins.materialConsumptionPluginV2.controller.PluginView', {
      types: {
      ...
      showDetailsOfComponent: function(oEvent) {
        ...
        if (!this.byId('postingsDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.PostingsDialog',
            controller: this
      ...
      showStorageLocationDetails: function(oEvent) {
        ...
        if (!this.byId('storageLocationDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.StorageLocationDialog',
            controller: this
          }).then(function(oDialog) {
            oView.addDependent(oDialog);
            oDialog.open();
      ...
      showBatchDetails: function(oEvent) {
        ...
        if (!this.byId('batchDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.BatchDialog',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
      ...
      openMaterialConsumptionPopup: function(oView) {
        if (!this.byId('consumeDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.ConsumeDialog',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
	...
	@@ -2469,14 +2527,26 @@ sap.ui.define([
      ...
      openAddDialog: function() {
        ...
        if (!this.byId('addDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.AddMaterial',
            controller: this
          }).then(
            function(oDialog) {
              oDialog.setEscapeHandler(
      ...
      openScanDialog: function() {
        ...
        if (!this.byId('scanDialog')) {
          ...
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.ScannerDialog',
            controller: this
          }).then(
            function(oDialog) {
      ...
      onFindHUInv: function() {
        ...
        Fragment.load({
          id: oView.getId(),
          name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.HandlingUnitDialog',
          controller: this
        }).then(function(oDialog) {
          oView.addDependent(oDialog);
          oDialog.open();
      ...
      onPressViewAlternateBoms: function(oEvent) {
        ...
        if (!this.byId('alternateComponentsDialog')) {
          Fragment.load({
            id: oView.getId(),
            name: 'stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.AlternateComponentsDialog',
            controller: this
          }).then(function(oDialog) {
            oDialog.setEscapeHandler(
              function(oPromise) {
      ...
      onWeighDialogCancel: function(oEvent) {
        ...
        //Refresh the material consumption data on close of weighing dialog
      ...
      _assignOperator: function(sResource) {
        ...
        var oPayload = {
          ...
          InUOM: oComponentData.bomComponent.unitOfMeasure,
