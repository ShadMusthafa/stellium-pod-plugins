sap.ui.define([
    ...
    var CalculatedInfoPopoverType = BaseObject.extend("stellium.ext.podplugins.materialConsumptionPluginV2.controller.CalculatedInfoPopover", {
        ...
        constructor: function (sId, mSettings) {
            ...
            if (!this._oCalculatedInfoPopoverView) {
                this._oCalculatedInfoPopoverView = sap.ui.xmlfragment(this._sBaseId, "stellium.ext.podplugins.materialConsumptionPluginV2.view.fragments.CalculatedInfo", this);
