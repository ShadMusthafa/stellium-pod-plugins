sap.ui.define([
    ...
    "stellium/ext/podplugins/materialConsumptionPluginV2/controller/ListFilterRoutingBrowse"
], function (JSONModel, BrowseBase, StatusFormatter, ObjectTypeFormatter, ListFilterRoutingBrowse) {
    "use strict";

    var RoutingBrowseType = BrowseBase.extend("stellium.ext.podplugins.materialConsumptionPluginV2.controller.RoutingBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new RoutingBrowseType("routingBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.materialConsumptionPluginV2.view.browse.RoutingBrowse",
