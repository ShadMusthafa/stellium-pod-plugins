sap.ui.define(['sap/ui/model/resource/ResourceModel', 'sap/dm/dme/podfoundation/control/PropertyEditor'], function(
  ...
  return PropertyEditor.extend('stellium.ext.podplugins.materialConsumptionPluginV2.builder.PropertyEditor', {
    constructor: function(sId, mSettings) {
      PropertyEditor.apply(this, arguments);
      this.setI18nKeyPrefix('materialConsumptionConfig.');
      this.setResourceBundleName('stellium.ext.podplugins.materialConsumptionPluginV2.i18n.builder');
      this.setPluginResourceBundleName('stellium.ext.podplugins.materialConsumptionPluginV2.i18n.i18n');
    },
