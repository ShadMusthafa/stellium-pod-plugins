sap.ui.define(
  ...
  function (
    ...
    var oPluginViewController = PluginViewController.extend('stellium.ext.podplugins.confirmationPlugin.controller.PluginView', {
      metadata: {
        properties: {}
      },
      ...
      onPressConfirmActivityDialog: function () {
        // Append Time
        let appendedDateTime = this.getView().getModel('actPostModel').getProperty('/postingDate') + ' ' + '00' + ':' + '00' + ':' + '00';
        ...
        if (this.actPostData.finalConfirmation && this.selectedOrderData.quantityValidation && !this.yieldOrScrapReported) {
      ...
      handleReasonCode: function () {
        ...
        //Load the fragment
        if (this.selectReasonCodeDialog === undefined) {
          this.selectReasonCodeDialog = sap.ui.xmlfragment('selectReasonCodeDialog', 'stellium.ext.podplugins.confirmationPlugin.view.fragments.SelectReasonCodeDialog', this);
      ...
      handleReasonCodeUpdateFromPopover: function (event) {
        ...
        if (!this.updateReasonCodeDialog) {
          this.updateReasonCodeDialog = sap.ui.xmlfragment('updateReasonCodeDialog', 'stellium.ext.podplugins.confirmationPlugin.view.fragments.UpdateReasonCodeDialog', this);
