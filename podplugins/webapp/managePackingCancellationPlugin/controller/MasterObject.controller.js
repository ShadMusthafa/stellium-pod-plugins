sap.ui.define(
  ...
  function (
    ...
    var oPluginViewController = PluginViewController.extend('stellium.ext.podplugins.managePackingCancellationPlugin.controller.MasterObject', {
      metadata: {
        properties: {}
      },
      ...
      onRouteMatched: function (oEvent) {
        ...
        this.byId('idMasterObjectPage').setSelectedSection(this.byId('goodsIssue'));
      ...
      cancelActQtyConfirmation: function (oEvent) {
        ...
        var oAssocConfirmation = this.getAssocConfirmation(oConfirmation.confirmationGroup, oConfirmation.confirmationCounter, oConfirmation.createdOn);
      ...
      onCancelConfirmationPress: function (oEvent) {
        ...
        var oData = oEvent.getSource().getBindingContext(oCustomData.dataModelName).getObject(),
      ...
      cancelGIGRConfirmation: function (oEvent, sCancelType, sModelName) {
        ...
        var aPackingItems = aPackingData.filter((oPackItem) => oPackItem.packedArticle === oConfirmationItem.material && oPackItem.packedBatch === oConfirmationItem.batch);
        ...
        if (aPackingItems.length === 0) {
          this.onSubmitDialogPress(this.cancelConfirmationData.item, this.cancelConfirmationData.cancelType, this.cancelConfirmationData.modelName);
          return;
        }
      ...
      _postUnPackToS4: function (aPayload) {
        ...
        var sUrl = this.getPublicApiRestDataSourceUri() + '/pe/api/v1/process/processDefinitions/start?key=REG_50315c9c-82d5-4684-a465-d1920be98505&async=false';
        var oPayload = {
          content: aPayload
        };
      ...
      showCancellationDialog: function () {
        ...
        Fragment.load({
          id: oView.getId(),
          name: 'stellium.ext.podplugins.managePackingCancellationPlugin.view.fragments.CancellationDialog',
          controller: this
        }).then(function (oDialog) {
          //Handle dialog close function on escape button press
          oDialog.setEscapeHandler(function (oPromise) {
      ...
      _getPackingDataFromS4: function () {
        var sUrl = this.getPublicApiRestDataSourceUri() + '/pe/api/v1/process/processDefinitions/start?key=REG_baae1b09-7a4d-4686-86b6-c49d4ff465f3&async=false';
