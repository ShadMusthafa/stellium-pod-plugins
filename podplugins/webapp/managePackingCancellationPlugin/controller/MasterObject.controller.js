    ...
    var oPluginViewController = PluginViewController.extend('stellium.ext.podplugins.managePackingCancellationPlugin.controller.MasterObject', {
      ...
      _readGoodsReceiptItemsSuccess: function(sTableName, bConcatFlag, oResponse) {
        ...
        if (oResponse) {
          ...
          this.getView().getModel('data').setProperty('/' + sTableName + '_TITLE', this.getI18nText(sTableName, [iTotalElements]));
      ...
      _readGoodsIssueItemsSuccess: function(oResponse) {
        if (oResponse) {
          ...
          this.getView().getModel('data').setProperty('/goodsIssueTitle', this.getI18nText('postingTitle', [oResponse.totalElements]));
