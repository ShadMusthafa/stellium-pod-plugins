sap.ui.define([
    ...
    "sap/dm/dme/inventoryplugins/goodsReceiptCustomPlugin/controller/ProductionProcessSelectionViewController",
    "sap/dm/dme/inventoryplugins/goodsReceiptCustomPlugin/controller/ServiceRegistry",
    "sap/ui/model/json/JSONModel"
], function (PropertyEditor, ProductionProcessSelectionViewController, ServiceRegistry, JSONModel) {
    "use strict";

    return PropertyEditor.extend("stellium.ext.podplugins.goodsReceiptCustomPlugin.builder.PropertyEditor", {
        constructor: function (sId, mSettings) {
            PropertyEditor.apply(this, arguments);
            this.setI18nKeyPrefix("goodsReceiptCustomPluginConfig.");
            this.setResourceBundleName("stellium.ext.podplugins.goodsReceiptCustomPlugin.i18n.builder");
            this.setPluginResourceBundleName("stellium.ext.podplugins.goodsReceiptCustomPlugin.i18n.i18n");
        },
        ...
        _getTypeDefinitionProductionProcessBrowseDialog: async function (oController) {
            ...
            let oDialog = await sap.ui.core.Fragment.load({
                name: "stellium.ext.podplugins.goodsReceiptCustomPlugin.view.browse.ProductionProcessSelectionDialog",
