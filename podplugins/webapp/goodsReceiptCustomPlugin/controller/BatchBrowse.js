sap.ui.define([
    ...
    let BatchBrowseType = BrowseBase.extend("stellium.ext.podplugins.goodsReceiptCustomPlugin.controller.BatchBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel, sTableId, sMaterial, sPlant, sInventoryDataSourceUri, fnFetchBatchInventoryDataCallback) {
            ...
            let oBatchBrowseType = new BatchBrowseType("batchBrowse", {
                ...
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.goodsReceiptCustomPlugin.view.fragment.BatchBrowse",
