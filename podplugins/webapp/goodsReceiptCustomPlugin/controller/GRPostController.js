sap.ui.define([
    ...
    "stellium/ext/podplugins/goodsReceiptCustomPlugin/controller/StorageLocationBrowse",
    ...
    return {
        ...
        showGRPostingsDialogs: function (oData) {
            ...
            if (!this.oController.byId("postingsDialog")) {
                Fragment.load({
                    id: oView.getId(),
                    name: "stellium.ext.podplugins.goodsReceiptCustomPlugin.view.fragment.GRPostingsDialog",
