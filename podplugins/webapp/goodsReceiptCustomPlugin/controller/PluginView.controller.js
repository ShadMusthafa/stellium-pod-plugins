sap.ui.define(
  [
    ...
    'stellium/ext/podplugins/goodsReceiptCustomPlugin/controller/GRPostController'
  ],
  function(
    ...
    return PluginViewController.extend('stellium.ext.podplugins.goodsReceiptCustomPlugin.controller.PluginView', {
