sap.ui.define([
    ...
    let StorageLocationBrowseType = BrowseBase.extend("stellium.ext.podplugins.goodsReceiptCustomPlugin.controller.StorageLocationBrowse", {
    ...
    return {
        ...
        open: function (oParentControl, sDefaultSearchValue, fnSelectionCallback, oModel) {
            return new StorageLocationBrowseType("storageLocationBrowse", {
                oModel: oModel,
                sFragmentName: "stellium.ext.podplugins.goodsReceiptCustomPlugin.view.fragment.StorageLocationsBrowse",
